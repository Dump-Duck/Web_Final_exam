...
<body>
    ...
    <div class="delete-song">
        ...
        ?>
                <form method="post">
                    ...
                    <hr style='border: 2px solid #3c2d57'>
                    <p id="button"><input type="submit" name="delete" value="Delete" style=cursor:pointer'><button style='margin-left:10px'><a href='song_manage.php' style='color:black'>Cancel</a></button></p>
                </form>
        <?php
            }
        }
    ...
    if (isset($_POST['delete'])) {
        ...
        if ($conn->query($delete_sql) == TRUE) {
            echo "<script>alert('Delete song successfully! You will be back to song management page after click OK!');</script>";
